...
def QC_L1(W,r, QC_max_iter = 5,device='cuda'):
    algo = RegulaizedL1AugmentedLagrangianMethod()
    ...
    for QC_iter in range(QC_max_iter):
        ...
        result = algo.decompose(D = (W - Wdq_new), r=r, device=device)  # Ensure decomposition happens on GPU
        E = result.A @ result.B.T
